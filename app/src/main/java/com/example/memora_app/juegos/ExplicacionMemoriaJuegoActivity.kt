...
class ExplicacionMemoriaJuegoActivity : AppCompatActivity() {
        ...
        firestore.collection("Pacientes")
            ...
            .addOnSuccessListener { doc ->
                if (doc.exists()) {
                    ...
                    val campo = doc.get("Memoria") as? Map<*, *>
                    if (campo != null) {
    ...
    private fun mostrarTextoSegunDificultad(dificultad: String) {
        val mensaje = when (dificultad) {
            "Dificultad Baja" -> "Se mostrarán varias imágenes de objetos. Luego le dará a siguiente y aparecerá una imagen con uno menos. El paciente deberá seleccionar cuál falta. Recuerda que las pistas quitan puntos y no olvides hacer zoom. ¡Ánimo!"
            "Dificultad Media" -> "Se mostrarán dos imágenes originales. Luego le dará a siguiente y aparecerá una imagen con dos menos. El paciente deberá seleccionar qué objetos faltan. Recuerda bien lo que viste y que las pistas quitan puntos y no olvides hacer zoom."
            "Dificultad Alta" -> "Se mostrarán imágenes con varios objetos. Luego le dará a siguiente y aparecerá una imagen con tres menos. El paciente deberá seleccionar qué objetos faltan. Recuerda que las pistas quitan puntos y no olvides hacer zoom. ¡Ánimo!"
