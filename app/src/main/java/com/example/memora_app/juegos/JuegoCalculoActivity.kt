...
class JuegoCalculoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (dificultadRecibida != null) {
            Log.d("JuegoCalculo", "Dificultad recibida por intent: '$dificultadRecibida'")
            preguntas = PreguntasCal.getPreguntasPorDificultadCal(dificultadRecibida)
            Log.d("JuegoCalculo", "Preguntas cargadas: ${preguntas.size}")
    ...
    private fun guardarResultado() {
        ...
        val intent = Intent(this, ResultadosCalculoActivity::class.java)
